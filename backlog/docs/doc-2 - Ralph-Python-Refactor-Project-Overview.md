...
- **Typecheck:** pyright (strict mode config-driven via [tool.pyright].strict) (`uv run pyright (strict mode config-driven via [tool.pyright].strict) skills/ralph-run/scripts`)
